...
INSERT INTO "new_stories" ("createdAt", "day", "id", "notes", "order", "projectId", "title", "updatedAt") SELECT "createdAt", "day", "id", "notes", "order", "projectId", "title", "updatedAt" FROM "stories";
DROP TABLE "stories";
