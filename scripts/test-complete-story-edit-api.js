...
function testCompleteStoryEditAPI() {
  const storyId = 'cmfa4xlro0001u3bks0nqarqo'; // تست story
  
  console.log('🧪 Testing complete story edit API...\n');
        ...
        res.on('end', () => {
          ...
          try {
            ...
            if (res.statusCode === 200) {
              ...
              console.log('📝 Description:', result.storyIdea?.description || 'None');
              console.log('📋 Guidelines:', result.storyIdea?.guidelines || 'None');
            } else {
