    ...
    >
      <Card className='backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl'>
        <CardHeader className='pb-4'>
          ...
          <p className='text-sm text-gray-600'>آخرین اعلان‌ها و یادآوری‌ها</p>
        </CardHeader>
              ...
              return (
                <OptimizedMotion
                  ...
                  className={`p-4 rounded-lg border ${
                    notification.isRead
                      ...
                      : `${notificationInfo.bgColor} ${notificationInfo.borderColor}`
                ...
                >
                  <div className='flex items-start rtl:items-start gap-3'>
                    ...
                    >
                      <NotificationIcon
                        className={`h-4 w-4 ${notificationInfo.color}`}
                      />
                    </div>
