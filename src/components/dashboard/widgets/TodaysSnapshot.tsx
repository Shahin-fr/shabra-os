              ...
              return (
                ...
                >
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden overflow-hidden overflow-hidden">
                      <OptimizedMotion
                        className="h-2 rounded-full bg-[#ff0a54]" style={{ transformOrigin: 'left center' }}
                        initial={{ scaleX: 0 }}
