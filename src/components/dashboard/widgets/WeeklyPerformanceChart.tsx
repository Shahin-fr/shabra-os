...
const avgEfficiency = Math.round(weeklyData.reduce((sum, d) => sum + d.efficiency, 0) / weeklyData.length);
        ...
        <CardHeader className="pb-4">
          <CardTitle className="flex items-center gap-3 text-xl font-bold">
            ...
            <div className="ml-auto text-right">
              ...
              <div className="text-sm text-muted-foreground">میانگین کارایی</div>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent>
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div                       className={`flex items-center gap-1 text-xs ${
                        day.efficiency >= 90 ? 'text-green-500' :
                        day.efficiency >= 80 ? 'text-[#ff0a54]' :
                        day.efficiency >= 70 ? 'text-yellow-500' : 'text-red-500'
                      }`}>
                        {day.efficiency >= 90 ? <TrendingUp className="h-3 w-3" /> :
                         day.efficiency >= 80 ? <Target className="h-3 w-3" /> :
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className={`w-16 h-3 rounded-full ${
                    ...
                    day.efficiency >= 80 ? 'bg-[#ff0a54]' :
                    day.efficiency >= 70 ? 'bg-yellow-500' : 'bg-red-500'
                  }`} />
                </div>
              </motion.div>
            ))}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  عملکرد تیم در این هفته {avgEfficiency >= 85 ? 'عالی' : avgEfficiency >= 75 ? 'خوب' : 'نیاز به بهبود'} بوده است. 
                  {avgEfficiency >= 85 ? ' تیم در مسیر درستی قرار دارد.' : ' پیشنهاد می‌شود روی مدیریت زمان تمرکز کنید.'}
                </p>
              </div>
            </div>
          </motion.div>
