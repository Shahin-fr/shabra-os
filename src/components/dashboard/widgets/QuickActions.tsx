...
import { Plus, Users, FileText, Calendar, Settings, BarChart3, UserPlus, Mail } from 'lucide-react';
              ...
              >
                <a href={action.href}>
                  <div className="flex items-center gap-4 w-full">
                    <div className={`w-12 h-12 ${action.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg`}>
