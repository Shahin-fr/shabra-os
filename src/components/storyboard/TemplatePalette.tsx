      ...
      {!isSlotSelected && (
        ...
        >
          <p className='text-sm text-gray-800'>
            💡 <strong>نکته:</strong> روی یک اسلات استوری در بالا کلیک کنید تا
            آن را انتخاب کنید، سپس قالب را انتخاب کنید.
          </p>
        </motion.div>
      )}
        ...
        {storyTypes.map(storyType => (
          ...
          >
            <Card
              ...
              onClick={() =>
                isSlotSelected && !isLoading && onTemplateClick(storyType.id)
              }
            >
