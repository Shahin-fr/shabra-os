        ...
        <div className="relative z-10 p-6">
          <Calendar
            ...
            classNames={{
              ...
              button_previous: 'h-8 w-8 select-none p-0 text-white hover:bg-white/10 hover:shadow-lg hover:shadow-pink-500/20 rounded-lg transition-all duration-200 backdrop-blur-sm flex items-center justify-center',
              button_next: 'h-8 w-8 select-none p-0 text-white hover:bg-white/10 hover:shadow-lg hover:shadow-pink-500/20 rounded-lg transition-all duration-200 backdrop-blur-sm flex items-center justify-center',
              month_caption: 'flex h-8 w-full items-center justify-center px-8 text-white font-semibold',
              dropdowns: 'flex h-8 w-full items-center justify-center gap-1.5 text-sm font-medium',
              dropdown_root: 'has-focus:border-pink-400/50 border-white/30 shadow-sm has-focus:ring-pink-400/50 has-focus:ring-2 relative rounded-lg border bg-white/10 backdrop-blur-sm',
              dropdown: 'bg-white/20 absolute inset-0 opacity-0',
              caption_label: 'select-none font-semibold text-white',
              table: 'w-full border-collapse',
              weekdays: 'flex',
              weekday: 'text-white/70 flex-1 select-none rounded-md text-sm font-medium',
              ...
              range_start: 'bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-l-lg shadow-lg shadow-pink-500/40',
              range_middle: 'bg-gradient-to-r from-pink-500/50 to-rose-500/50 text-white rounded-none',
              range_end: 'bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-r-lg shadow-lg shadow-pink-500/40',
              today: 'bg-white/20 text-white rounded-lg data-[selected=true]:rounded-none font-semibold',
