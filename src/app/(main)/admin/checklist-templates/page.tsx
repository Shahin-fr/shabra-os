        ...
        >
          <div className='flex items-center gap-3 mb-4'>
            <div className='p-2 bg-[#ff0a54]/10 rounded-xl'>
              <ClipboardList className='h-6 w-6 text-[#ff0a54]' />
            </div>
            <div>
              <h1 className='text-2xl font-bold text-gray-900'>
                مدیریت قالب‌های چک‌لیست
              </h1>
              <p className='text-gray-600'>ایجاد و مدیریت قالب‌های فرآیندهای استخدام و ترک کار</p>
            </div>
          </div>
        </OptimizedMotion>

        {/* Checklist Templates Dashboard */}
