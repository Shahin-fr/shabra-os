...
import { ActionCenterDashboard } from '@/components/admin/action-center/ActionCenterDashboard';
        ...
        >
          <div className='flex items-center gap-3 mb-4'>
            <div className='p-2 bg-[#ff0a54]/10 rounded-xl'>
              <Inbox className='h-6 w-6 text-[#ff0a54]' />
            </div>
            <div>
              <h1 className='text-2xl font-bold text-gray-900'>
                مرکز اقدامات مدیر
              </h1>
              <p className='text-gray-600'>مدیریت درخواست‌های کارمندان</p>
            </div>
          </div>
        </OptimizedMotion>
