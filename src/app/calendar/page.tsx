  ...
  return (
    <div className='container mx-auto max-w-7xl space-y-8'>
      ...
      <div className='text-center space-y-4'>
        <h1 className='text-4xl font-bold text-gray-900'>تقویم تیمی</h1>
        ...
        <CardContent>
          <div className='text-center py-16'>
            ...
            <p className='text-gray-600 max-w-md mx-auto mb-8'>
              نمای کامل تقویم تیمی در اینجا قرار خواهد گرفت. این بخش شامل
              برنامه‌ریزی رویدادها، جلسات تیمی و مدیریت زمان خواهد بود.
            </p>
