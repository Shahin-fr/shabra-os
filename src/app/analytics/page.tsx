...
import { BarChart3, TrendingUp, PieChart, Activity, Target, Users } from "lucide-react";
          ...
          <CardContent>
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 max-w-md mx-auto mb-8">
                داشبوردهای تحلیل عملکرد و گزارش‌های کلیدی در اینجا نمایش داده خواهند شد. این بخش شامل آمار پروژه‌ها، عملکرد تیم و تحلیل‌های پیشرفته خواهد بود.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <div className="p-6 rounded-xl border border-white/20 bg-white/5 backdrop-blur-sm">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-3">روند عملکرد</h4>
                  <p className="text-sm text-gray-600">تحلیل روندهای عملکرد تیم و پروژه‌ها</p>
                </div>
                ...
                <div className="p-6 rounded-xl border border-white/20 bg-white/5 backdrop-blur-sm">
                  ...
                  <p className="text-sm text-gray-600">تحلیل توزیع کار و زمان‌بندی</p>
                </div>
                ...
                <div className="p-6 rounded-xl border border-white/20 bg-white/5 backdrop-blur-sm">
                  ...
                  <p className="text-sm text-gray-600">نظارت بر فعالیت‌های روزانه</p>
                </div>
                ...
                <div className="p-6 rounded-xl border border-white/20 bg-white/5 backdrop-blur-sm">
                  ...
                  <p className="text-sm text-gray-600">پیگیری پیشرفت اهداف و KPI</p>
                </div>
                ...
                <div className="p-6 rounded-xl border border-white/20 bg-white/5 backdrop-blur-sm">
                  ...
                  <p className="text-sm text-gray-600">تحلیل عملکرد فردی و تیمی</p>
                </div>
                ...
                <div className="p-6 rounded-xl border border-white/20 bg-white/5 backdrop-blur-sm">
                  ...
                  <p className="text-sm text-gray-600">گزارش‌های دوره‌ای و سفارشی</p>
                </div>
              </div>
            </div>
          </CardContent>
